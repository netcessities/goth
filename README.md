# Goth: Multi-Provider Authentication for Go [![GoDoc](https://godoc.org/github.com/netcessities/goth?status.svg)](https://godoc.org/github.com/netcessities/goth) [![Build Status](https://travis-ci.org/netcessities/goth.svg)](https://travis-ci.org/netcessities/goth)
...
```text
$ go get github.com/netcessities/goth
```
...
```text
$ git clone git@github.com:netcessities/goth.git
```
or use
```text
$ go get github.com/netcessities/goth
